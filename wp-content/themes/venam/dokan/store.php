...
<div id="dokan-primary" class="dokan-single-store">
    <div id="dokan-content" class="store-page-wrap woocommerce" role="main">
        ...
        <div class="nt-theme-inner-container shop-area gray-bg pt-0 pb-50">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <?php
                        if ( '1' == venam_settings( 'breadcrumbs_visibility', '1' ) ) {
                    ...
                    <div class="<?php echo esc_attr( $column ); ?>">
                            ...
                            <form class="dokan-store-products-ordeby" method="get">
                                <div class="wc--row row before-shop--loop align-items-center">
                                    <div class="col-12 col-lg-8 catalog--ordering">
                                        <input type="text" name="product_name" class="product-name-search dokan-store-products-filter-search"  placeholder="<?php esc_attr_e( 'Enter product name', 'venam' ); ?>" autocomplete="off" data-store_id="<?php echo esc_attr( $store_id ); ?>">
                                        <input type="submit" name="search_store_products" class="search-store-products dokan-btn-theme" value="<?php esc_attr_e( 'Search', 'venam' ); ?>">
                                    ...
                                    <?php if ( is_array( $orderby_options['catalogs'] ) && isset( $orderby_options['orderby'] ) ) : ?>
                                        <div class="col-12 col-lg-4 catalog--ordering">
                                            <select name="product_orderby" class="orderby orderby-search" aria-label="<?php esc_attr_e( 'Shop order', 'venam' ); ?>" onchange='if(this.value != 0) { this.form.submit(); }'>
                        ...
                        if ( have_posts() ) {
                            ...
                            <p class="dokan-info"><?php esc_html_e( 'No products were found of this vendor!', 'venam' ); ?></p>
