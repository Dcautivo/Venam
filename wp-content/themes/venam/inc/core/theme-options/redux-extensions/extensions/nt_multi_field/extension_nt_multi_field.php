        ...
        private function is_minimum_version () {
            ...
            if ($this->min_redux_version != '') {
                if (version_compare($redux_ver, $this->min_redux_version) < 0) {
                    $msg = '<strong>' . esc_html__( 'The', 'venam') . ' ' .  $this->ext_name . ' ' .  esc_html__('extension requires', 'venam') . ' Redux Framework ' . esc_html__('version', 'venam') . ' ' . $this->min_redux_version . ' ' .  esc_html__('or higher.','venam' ) . '</strong>&nbsp;&nbsp;' . esc_html__( 'You are currently running', 'venam') . ' Redux Framework ' . esc_html__('version','venam' ) . ' ' . $redux_ver . '.<br/><br/>' . esc_html__('This field will not render in your option panel, and features of this extension will not be available until the latest version of','venam' ) . ' Redux Framework ' . esc_html__('has been installed.','venam' );
