...
if( !class_exists( 'ReduxFramework_nt_multi_field' ) ) {
    ...
    class ReduxFramework_nt_multi_field {
        ...
        public function render() {
            ...
            $this->add_text   = ( isset( $this->field['add_text'] ) ) ? $this->field['add_text'] : esc_html__( 'Add More', 'venam' );
            ...
            if ( isset( $this->value ) && is_array( $this->value ) ) {
                ...
                foreach ( $this->value as $k => $value ) {
                        ...
                        if ( $count % count($this->field['placeholder']) == (count($this->field['placeholder']) - 1 ) ) {
                            echo  '<a' . ' data-id="' . $this->field['id'] . '-ul" href="javascript:void(0);" class="deletion nt-multi-field-remove">' . esc_html__( 'Remove', 'venam' ) . '</a>';
                        echo '</li>';
