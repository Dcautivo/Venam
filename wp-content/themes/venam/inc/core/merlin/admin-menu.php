...
function ninetheme_admin_menu() {
    ...
    */
    ...
    $parent_title = esc_html__( 'NineTheme', 'venam' );
    $icon         = 'dashicons-chart-pie';
    $main_panel   = 'ninetheme_panel';
    // Submenu page
    $sub_title1   = sprintf( '%s %s',esc_html__( 'About ', 'venam' ), $theme_name );
    $sub_slug     = 'ninetheme_about_page';
    // Submenu page
    $sub_title2   = esc_html__( 'Theme Activation', 'venam' );
            ...
            <div class="c-row">
                ...
                <div class="c-md-5 c-content">
                    <div class="c-inner">
                        ...
                        <h2 class="c-title"><?php esc_html_e( 'Support', 'venam' ); ?></h2>
                        <br>
                        <h4 class="c-title"><?php esc_html_e( 'Help Center', 'venam' ); ?></h4>
                        <a class="c-link" target="_blank" href="https://ninetheme.com/support/"><?php esc_html_e( 'Help Center', 'venam' ); ?></a>

                        <p class="c-text"><?php esc_html_e( 'If you need support with using the theme,
                        please visit the links below. If you are having trouble with the installation, please read the documentation.', 'venam' ); ?></p>

                        <br>
                        <br>
                        <h4 class="c-title"><?php esc_html_e( 'Theme Documentations', 'venam' ); ?></h4>
                        <a class="c-link" target="_blank" href="https://ninetheme.com/docs/elementor-themes-documentation/"><?php esc_html_e( 'Theme Elementor Documentation', 'venam' ); ?></a>
                        <a class="c-link" target="_blank" href="https://ninetheme.com/docs/elementor-themes-documentation/"><?php esc_html_e( 'Theme WPBakery Documentation', 'venam' ); ?></a>

                        <br>
                        <br>
                        <h4 class="c-title"><?php esc_html_e( 'Plugin Documentations', 'venam' ); ?></h4>
                        <a class="c-link" target="_blank" href="https://elementor.com/help/how-to-use-elementor/"><?php esc_html_e( 'Elementor General Documentation', 'venam' ); ?></a>
                        <a class="c-link" target="_blank" href="https://kb.wpbakery.com/"><?php esc_html_e( 'WPBakery General Documentation', 'venam' ); ?></a>
                        <a class="c-link" target="_blank" href="https://docs.pluginize.com/category/126-custom-post-type-ui/"><?php esc_html_e( 'CPTUI General Documentation', 'venam' ); ?></a>
                        <a class="c-link" target="_blank" href="https://contactform7.com/docs/"><?php esc_html_e( 'Contact Form 7 General Documentation', 'venam' ); ?></a>

                        <br>
                        <br>
                        <h4 class="c-title"><?php esc_html_e( 'Follow Us', 'venam' ); ?></h4>
                    ...
                    <div class="c-inner">
                        ...
                        if ( isset( $_POST['ninetheme_deactivate_licence'] ) ) {
                            wp_remote_post('https://api.ninetheme.com/deactivate', array(
                                ...
                                'body' => array(
                                    'purchase_code' => trim( get_option('envato_purchase_code_33546846') ),
                                    'theme_name' => 'venam',
                            ...
                            if ( get_option('envato_purchase_code_33546846') ) {
                                delete_option('envato_purchase_code_33546846');
                            }
                        }

                        if ( false == get_option('envato_purchase_code_33546846') ) {
                            update_option( 'ninetheme_deactivated_licence', 'yes' );
                            ?>
                            <h4 class="c-title"><?php esc_html_e( 'Activate License', 'venam' ); ?></h4>
                            <p class="c-text"><?php esc_html_e( 'Envato allows 1 license for 1 project located on 1 domain. It means that 1 purchase key can be used only for 1 site. Each additional site will require an additional purchase key.', 'venam' ); ?></p>
                            <p class="c-text"><?php esc_html_e( 'Please click to connect your license and enter your purchase code.', 'venam' ); ?></p>
                            ...
                            <h4 class="c-title"><?php esc_html_e( 'Disconnect License', 'venam' ); ?></h4>
                            <p class="c-text"><?php esc_html_e( 'If you want to use this template on another server, click the disconnect button here. When you disconnect, this creates a registration and a list of domains for which you used the purchase code will be saved. In case of illegal use of licenses, there is a risk that your Envato account will be deleted or your purchase code will be canceled. Do not share your license code with anyone other than our support team.', 'venam' ); ?></p>
                            ...
                            <form class="deactivate-form" method="post">
                                <button type="submit" class="button button-primary ninetheme-deactivate-licence" name="ninetheme_deactivate_licence">
                                    <?php esc_html_e( 'Disconnect', 'venam' ); ?>
                                </button>
                            </form>
                            <?php
                        }
