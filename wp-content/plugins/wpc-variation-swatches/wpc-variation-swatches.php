...
! defined( 'WPCVS_VERSION' ) && define( 'WPCVS_VERSION', '2.1.2' );
		...
		if ( ! class_exists( 'WPCleverWpcvs' ) && class_exists( 'WC_Product' ) ) {
			class WPCleverWpcvs {
				...
				function register_settings() {
					// settings
					register_setting( 'wpcvs_settings', 'wpcvs_button_default' );
					register_setting( 'wpcvs_settings', 'wpcvs_second_click' );
					register_setting( 'wpcvs_settings', 'wpcvs_tooltip' );
					register_setting( 'wpcvs_settings', 'wpcvs_style' );
					register_setting( 'wpcvs_settings', 'wpcvs_archive_enable' );
					register_setting( 'wpcvs_settings', 'wpcvs_archive_position' );
					register_setting( 'wpcvs_settings', 'wpcvs_archive_product' );
					register_setting( 'wpcvs_settings', 'wpcvs_archive_image' );
					register_setting( 'wpcvs_settings', 'wpcvs_archive_atc' );
					register_setting( 'wpcvs_settings', 'wpcvs_archive_atc_text' );
				}
							...
							<?php if ( $active_tab === 'settings' ) {
                                ...
                                <form method="post" action="options.php">
                                    <table class="form-table">
                                        ...
                                        <tr class="submit">
                                            <th colspan="2">
												<?php settings_fields( 'wpcvs_settings' ); ?>
												<?php submit_button(); ?>
                                            </th>
                                        </tr>
                                    </table>
