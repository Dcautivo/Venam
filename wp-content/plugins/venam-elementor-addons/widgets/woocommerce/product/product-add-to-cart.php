...
class Venam_WC_Product_Add_To_Cart extends Widget_Base {

    public function get_name() {
        return 'venam-wc-product-add-to-cart';
    }
    public function get_title() {
        return __( 'Add To Cart', 'venam' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'button_bg_color',
            [
                'label' => __( 'Background Color', 'venam' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_transition',
            [
                'label' => __( 'Transition Duration', 'venam' ),
    ...
    protected function render() {
        ...
        <div class="venam-add-to-cart venam-product-<?php echo esc_attr( $product->get_type() ); ?>">
