...
class Venam_WC_Product_Rating extends Widget_Base {

	public function get_name() {
		return 'venam-wc-product-rating';
	}

	public function get_title() {
		return __( 'Product Rating', 'venam' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'empty_star_color',
			[
				'label' => __( 'Empty Star Color', 'venam' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'prefix_class' => 'venamduct-rating--align-',
			]
		);
