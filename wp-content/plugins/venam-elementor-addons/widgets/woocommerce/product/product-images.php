...
class Venam_WC_Product_Images extends Widget_Base {

    public function get_name() {
        return 'venam-wc-product-images';
    }

    public function get_title() {
        return __( 'Product Images', 'venam' );
    }
