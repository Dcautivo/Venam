...
class Venam_WC_Product_Data_Tabs extends Widget_Base {

	public function get_name() {
		return 'venam-wc-product-data-tabs';
	}

	public function get_title() {
		return __( 'Product Data Tabs', 'venam' );
	}
