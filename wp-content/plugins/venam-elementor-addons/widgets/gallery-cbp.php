...
class Venam_Gallery extends Widget_Base {
    use Venam_Helper;
    public function get_name() {
        return 'venam-gallery';
    }
    ...
    protected function register_controls() {
        ...
        $this->venam_query_controls( 'post', false, true );
        ...
        $this->add_control( 'layoutmode',
            [
                ...
                'default' => 'fitRows',
                'options' => [
                    'fitRows' => esc_html__( 'Fit Rows', 'venam' ),
        ...
        $this->add_control( 'hidetitle',
            [
                'label' => esc_html__( 'Hide Post Title', 'venam' ),
                'type' => Controls_Manager::SWITCHER
            ]
        );
