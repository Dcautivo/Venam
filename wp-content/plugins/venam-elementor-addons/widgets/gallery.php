...
class Venam_Portfolio extends Widget_Base {
    use Venam_Helper;
    public function get_name() {
        return 'venam-portfolio';
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section( 'post_query_section',
            [
                'label' => esc_html__( 'Post Query', 'venam' ),
                'tab' => Controls_Manager::TAB_CONTENT
            ]
        );
        
        $this->venam_query_controls( 'post', $pag=false, $filter=true );
        $this->add_control( 'linktype',
            [
                'label' => esc_html__( 'Link Type', 'venam' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'permalink' => esc_html__( 'Permalink', 'venam' ),
                    'ajax' => esc_html__( 'Popup Single Page', 'venam' ),
                    'lightbox' => esc_html__( 'Lightbox', 'venam' ),
                ],
                'default' => 'lightbox'
            ]
        );
        ...
        $this->add_control( 'layoutmode',
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'grid' => esc_html__( 'grid masonry', 'venam' ),
        ...
        $this->add_control( 'navigation',
            [
                'label' => esc_html__( 'Slider Navigation', 'venam' ),
        ...
        $this->add_control( 'spagination',
            [
                'label' => esc_html__( 'Slider Dots', 'venam' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
                'condition' => ['layoutmode' => 'slider']
            ]
        ...
        $this->add_control( 'pause',
            [
                'label' => esc_html__( 'Pause on Hover', 'venam' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => ['layoutmode' => 'slider']
            ]
        ...
        $this->add_control( 'xlcount',
            [
                'label' => esc_html__( 'X-Large Device Column', 'venam' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 1,
                'max' => 10,
                'step' => 1,
        ...
        $this->add_control( 'lgcount',
            [
                'label' => esc_html__( 'Desktop Column', 'venam' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 1,
                'max' => 10,
                'step' => 1,
        ...
        $this->add_control( 'smcount',
            [
                'label' => esc_html__( 'Tablet Column', 'venam' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 1,
                'max' => 10,
                'step' => 1,
        ...
        $this->add_control( 'xscount',
            [
                'label' => esc_html__( 'Phone Column', 'venam' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 1,
                'max' => 10,
                'step' => 1,
        ...
        $this->add_control( 'showfilter',
            [
                'label' => esc_html__( 'Show Filter', 'venam' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes'
            ]
        );
        $this->add_control( 'filteralltext',
            [
                'label' => esc_html__( 'Filter First Text ( All )', 'venam' ),
        ...
        $this->add_control( 'filtercounter',
            [
                'label' => esc_html__( 'Filter Counter', 'venam' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => ['showfilter' => 'yes']
            ]
        ...
        $this->add_control( 'animation_divider',
            [
                'label' => esc_html__( 'ANIMATION', 'venam' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control( 'animationfilter',
            [
                'label' => esc_html__( 'Filter Animation', 'venam' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'fadeOut' => 'fadeOut',
                    'quicksand' => 'quicksand',
        ...
        $this->add_control( 'animationcaption',
            [
                'label' => esc_html__( 'Caption Animation', 'venam' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'pushTop',
                'options' => [
                    'pushTop' => 'pushTop',
        ...
        $this->add_control( 'pagination_divider',
            [
                'label' => esc_html__( 'POST PAGINATION', 'venam' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => ['layoutmode!' => 'slider']
            ]
        ...
        $this->add_control( 'prevtext',
            [
                'label' => esc_html__( 'Pagination Text ( Previous Page )', 'venam' ),
                'type' => Controls_Manager::TEXT,
        ...
        $this->add_control( 'nexttext',
            [
                'label' => esc_html__( 'Pagination Text ( Next Page )', 'venam' ),
                'type' => Controls_Manager::TEXT,
                'default' => 'Next Page',
                'condition' => ['layoutmode!' => 'slider']
            ]
        ...
        $this->add_control( 'lazy',
            [
                'label' => esc_html__( 'Lazy Load', 'venam' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
            ]
        );
        $this->add_control( 'ltitle',
            [
                'label' => esc_html__( 'Lightbox Post Title', 'venam' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
        ...
        $this->add_control( 'showicon',
            [
                'label' => esc_html__( 'Post Icon', 'venam' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes'
            ]
        );
        $this->add_control( 'showtitle',
            [
                'label' => esc_html__( 'Post Title', 'venam' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
        $this->add_control( 'showcat',
            [
                'label' => esc_html__( 'Post Category', 'venam' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes'
            ]
        );
        ...
        $this->start_controls_tab('filter_hover_tab',
            [ 'label' => esc_html__( 'Hover/Active', 'venam' ) ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'box_border',
                'label' => esc_html__( 'Item Border', 'venam' ),
                'selector' => '{{WRAPPER}} .cbp .cbp-item',
            ]
        );
        $this->add_control( 'activewrap_bgcolor',
            [
                'label' => esc_html__( 'Text Content Background Color', 'venam' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $this->add_control( 'cats_sdivider',
            [
                'label' => esc_html__( 'CATEGORIES', 'venam' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
    ...
    protected function render() {
        ...
        if ( $the_query->have_posts() ) {
            echo '<div class="gallery-cbp gallery-'.$settingsid.'">';
                ...
                $exclude = array();
                $taxonomy = '';
                $post_type = $this->venam_get_post_types();
                ...
                echo '<div class="gallery-elementor cbp'.$sliderclass.' type-'.$layoutmode.'">';
                    ...
                    while ( $the_query->have_posts() ) {
                        ...
                        $linktype = get_post_meta( get_the_ID(), 'venam_projects_link_type', true );
                        $vidurl   = get_post_meta( get_the_ID(), 'venam_projects_video_url', true );
                        $c_url    = get_post_meta( get_the_ID(), 'venam_projects_custom_url', true );
                        $gallery  = get_post_meta( get_the_ID(), 'venam_port_gallery_image', true );
                ...
                if ( $layoutmode != 'slider' && $settings['pagination'] == 'yes' ) {
                    $prevtext = $settings['prevtext'] ? $settings['prevtext'] : esc_html__( 'Previous Page', 'venam' );
                    $nexttext = $settings['nexttext'] ? $settings['nexttext'] : esc_html__( 'Next Page', 'venam' );
