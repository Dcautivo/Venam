...
class Library_Source extends Source_Base {
    ...
    */
    const LIBRARY_CACHE_KEY = 'venam_library_cache';
    ...
    */
    ...
    public function get_title() {
        return __( 'Venam Library', 'happy-elementor-addons' );
    }
        ...
        */
        ...
        public static function request_template_data( $template_id ) {
            ...
            $body = [
                ...
                'version' => VENAM_PLUGIN_VERSION,
            ];
            /*
            if ( venam_has_pro() ) {
            $body['has_pro'] = 1;
            $body['pro_version'] = VENAM_PLUGIN_VERSION;
        }
        */
    ...
    */
    public function get_data( array $args, $context = 'display' ) {
        ...
        if ( empty( $data ) || empty( $data['content'] ) ) {
            throw new \Exception( __( 'Template does not have any content', 'venam' ) );
        }
