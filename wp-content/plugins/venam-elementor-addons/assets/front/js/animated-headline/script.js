!(function ($) {
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction( 'frontend/element_ready/venam-animated-headline.default', ntrAnimatedHeadline );
        elementorFrontend.hooks.addAction('frontend/element_ready/venam-onepage.default', ntrAnimatedHeadline);
    });
